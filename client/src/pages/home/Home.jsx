...
const Home = () => {
  ...
  const columns = [
    ...
    { field: "back", headerName: "Mặt sau", width: 180 ,editable: false,
    sortable: true,
    filterable: true,},
    { field: "level", headerName: "Cấp độ", width: 180 ,editable: false,
    sortable: true,
    filterable: true,},
    {
      field: "action",
      ...
      >
        ...
        <Dialog
          ...
          >
            ...
            <DialogContent>
              <DialogContentText id="alert-dialog-description">
                Bạn đang xóa bộ thẻ {currentSet.set.title}.
                Thao tác này sẽ không thể hoàn tác!!
              </DialogContentText>
            </DialogContent>
            <DialogActions>
          ...
          <ListItemButton>
            ...
            <ListItemText primary="Thêm thẻ mới" />
        </ListItemButton>
